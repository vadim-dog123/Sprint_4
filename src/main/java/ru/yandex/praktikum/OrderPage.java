...
public class OrderPage {
    ...
    //Поле имя'
    private final By nameField = By.xpath("//input[@class='Input_Input__1iN_Z Input_Error__1Tx5d Input_Responsible__1jDKN']");
    //Поле фамилия
    ...
    //Кнопка далее
    private final By nextButton = By.xpath("//input[@class='Button_Button__ra12g Button_Middle__1CSJM']");
